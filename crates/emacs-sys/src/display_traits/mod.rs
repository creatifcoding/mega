...
impl From<face_id> for FaceId {
    fn from(t: face_id) -> Self {
        match t {
            ...
            face_id::HEADER_LINE_ACTIVE_FACE_ID => FaceId::HeaderLineActive,
            face_id::HEADER_LINE_INACTIVE_FACE_ID => FaceId::HeaderLineInactive,
...
impl Into<face_id> for FaceId {
    fn into(self) -> face_id {
        match self {
            ...
            FaceId::HeaderLineActive => face_id::HEADER_LINE_ACTIVE_FACE_ID,
            FaceId::HeaderLineInactive => face_id::HEADER_LINE_INACTIVE_FACE_ID,
